# bot.py — полная версия с health-проверкой для Render
...
if not TOKEN or not API_URL or not API_KEY:
    raise ValueError("BOT_TOKEN, API_URL, API_KEY должны быть в .env")
...
# ========== ЗАПУСК ==========
def main():
    # Запускаем health-сервер в отдельном потоке для Render
